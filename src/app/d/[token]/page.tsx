...
export default function DownloadPage() {
  ...
  const ext = shareInfo ? getFileExtension(shareInfo.fileName) : 'FILE';
  const fileType = shareInfo ? getFileTypeLabel(shareInfo.fileName) : 'File';
      ...
      <main className="container mx-auto px-4 py-10 max-w-2xl">
            ...
            >
              {verifying ? (
                ...
                <>
                  ...
                  Download {formatFileSize(shareInfo?.fileSize || 0)}
                </>
              )}
            </button>
            {shareInfo?.pinProtected && (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm mt-4 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100">
            <h2 className="font-semibold text-[#0f172a]">File Details</h2>
          </div>
          <div className="divide-y divide-gray-50">
            <div className="flex items-center justify-between px-6 py-3">
              <span className="text-sm text-gray-500">File name</span>
              <span className="text-sm font-medium text-[#0f172a] truncate max-w-[200px]">{shareInfo?.fileName}</span>
            </div>
            <div className="flex items-center justify-between px-6 py-3">
            ...
            <div className="flex items-center justify-between px-6 py-3">
              ...
              <span className="text-sm font-medium text-[#0f172a]">{formatFileSize(shareInfo?.fileSize || 0)}</span>
            </div>
            <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                This file is shared via CloudShare with end-to-end encryption.
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm mt-4 p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              { step: '2', text: 'Your file will begin downloading automatically' },
              { step: '3', text: 'Save the file to your preferred location' },
            ].map((item) => (
